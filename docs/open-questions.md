...
- ⚠️ **本条重新成为阻塞项**（2026-09-16 路线切换至 fanhao375 后）。此前走 AI-FanGe 路线时用现成 OpenRB-150 绕开了它，现在两块板都要自己打样，这块是风险最高的单点
- 退路：fanhao375 有一份「不打 HAT」方案（¥70 模块 + 飞线），但那只替代 HAT，`imu_to_dxl` 仍需打样。见 [roadmap.md](roadmap.md) 阶段 5
