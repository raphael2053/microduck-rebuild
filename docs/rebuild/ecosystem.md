...
**本仓已选定 fanhao375 路线**（2026-09-16 从 AI-FanGe 切换）。

推翻原选择的不是技术判断而是**采购实况**：XL330 在 Seeed 需 4–6 周且"付款后才开始生产"，淘宝涨到 ¥700–1000/颗；飞特 HD-1910 ¥122/颗、15 天内发货。⚠️ 代价是接手了三项 AI-FanGe 路线下不存在的工作：两块 PCB 打样、协议模块替换、策略全部重训。

决定过程与执行计划见 [roadmap.md](roadmap.md)。
